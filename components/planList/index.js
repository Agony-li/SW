...
async getNewsList(num,pNum){
 let data = await util.httpRequestWithPromise('/rest/cms/articles?category=0001&pageNo='+pNum,'GET','','');
   console.log(data);
...
async getNewsList1(){
  let data = await util.httpRequestWithPromise('/rest/cms/articles?category=0001&pageNo='+this.data.pageNo,'GET','','');
    console.log(data);
    if(data.statusCode === 200){
