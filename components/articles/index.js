...
async getDetail(id, form){
  ...
  playaudio:function(e) {
    ...
    let audioSave = this.data.audioSave;
    if (audioSave == e.currentTarget.dataset.title) {
      bgm.stop();
      //初始化  
      this.setData({
        audioSave: ''
        ...
        bgm.protocol = 'http'
        bgm.title = e.currentTarget.dataset.title
        bgm.src = audio;
        bgm.play();
      this.setData({
        audioSave: e.currentTarget.dataset.title
      })
